            ...
            Zt && (yn = Tn = Un = Kn = wt = In = zn = Rn = !1), F && (Lt = F, zt = "translate", zt += tt ? "X(" : "Y(", Bt = ")"),
                function() {
                    ...
                    sn && (bn ? (vn = bn.children[0], hn = bn.children[1], g(bn, {
                        ...
                        "aria-controls": Kt,
                        tabindex: "-1"
                    })) : (nt.insertAdjacentHTML("afterbegin", '<div class="tns-controls" aria-label="Carousel Navigation" tabindex="0"><button data-controls="prev" tabindex="-1" aria-controls="' + Kt + '" type="button">' + gn[0] + '</button><button data-controls="next" tabindex="-1" aria-controls="' + Kt + '" type="button">' + gn[1] + "</button></div>"), bn = nt.querySelector(".tns-controls"), vn = bn.children[0], hn = bn.children[1]), pn = re(vn), mn = re(hn), Ot || se(pn, vn, !0), D(bn, _t), yn || x(bn)), Un && D(at, rn), Kn && D(at, on), wt && D(z, an), "inner" === xt ? Xt.on("outerResized", function() {
